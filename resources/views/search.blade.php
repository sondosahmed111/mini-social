                ...
                <div class="glass-card animate__animated animate__fadeIn">
                    <div class="card-body p-4">
                        ...
                        <div class="input-group mb-4">
                            <input type="text" class="form-control" id="search-input" placeholder="ابحث عن مستخدم..."
                                style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;">
                            <button class="neo-btn" id="search-button"
                                style="border-top-left-radius: 12px; border-bottom-left-radius: 12px;">بحث</button>
                        </div>
                        ...
                        <div class="search-results">
                            <div class="glass-card p-3 mb-3 user-card">
                                <div class="d-flex align-items-center">
                                    <div class="user-avatar me-3 glow-animation"
                                        style="width: 50px; height: 50px; font-size: 1.2rem;">A</div>
                            ...
                            <div class="glass-card p-3 mb-3 user-card">
                                <div class="d-flex align-items-center">
                                    <div class="user-avatar me-3 glow-animation"
                                        style="width: 50px; height: 50px; font-size: 1.2rem;">S</div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="glass-card p-3 mb-3 user-card">
                                <div class="d-flex align-items-center">
                                    <div class="user-avatar me-3 glow-animation"
                                        style="width: 50px; height: 50px; font-size: 1.2rem;">M</div>
                                    <div class="flex-grow-1">
