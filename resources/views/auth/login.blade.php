            ...
            <div class="glass-card animate__animated animate__fadeInUp float-animation" style="background: linear-gradient(135deg, rgba(255,255,255,0.1), rgba(255,255,255,0.05)); backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.2);">
                <div class="card-body p-5">
                    <div class="text-center mb-5">
                        ...
                        <h2 class="card-title glow-text mb-3" style="font-weight: 700; font-size: 2rem;">تسجيل الدخول</h2>
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control glass-input" id="password" name="password" placeholder="أدخل كلمة المرور" required style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); color: var(--text-primary);">
                            </div>
                        </div>
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="remember" name="remember" style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2);">
                                <label class="form-check-label text-muted" for="remember">تذكرني</label>
                            </div>
                            <a href="#" class="text-decoration-none glow-text" style="font-weight: 500;">نسيت كلمة المرور؟</a>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="glass-card p-3" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);">
                            <p class="mb-0">ليس لديك حساب؟ <a href="{{ route('register.view') }}" class="text-decoration-none glow-text fw-bold">إنشاء حساب جديد</a></p>
                        </div>
                    </div>
                </div>
            </div>
